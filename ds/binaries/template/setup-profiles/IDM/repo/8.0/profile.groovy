...
ds.addIndex "fr-idm-account-id", "equality"
ds.addIndex "fr-idm-account-name", "big-equality"
ds.addIndex "fr-idm-account-type", "big-equality"
ds.addIndex "fr-idm-account-applicationId", "big-equality"
ds.addIndex "fr-idm-account-constraint", "equality"
ds.addIndex "fr-idm-pending-account-name", "big-equality"
ds.addIndex "fr-idm-pending-account-type", "big-equality"
ds.addIndex "fr-idm-pending-account-applicationId", "big-equality"
ds.addIndex "fr-idm-pending-account-constraint", "equality"
...
ds.addIndex "fr-idm-managed-application-name", "equality"
...
for (def attributeName : List.of(
        "fr-idm-account-owner",
        "fr-idm-pending-account-owner",
...
ds.config "create-plugin",
        "--plugin-name", "Account Unique Attribute",
        "--type", "unique-attribute",
        "--set", "type:fr-idm-account-constraint",
        "--set", "base-dn:ou=account,dc=openidm," + domain,
        "--set", "enabled:true"

ds.config "create-plugin",
        "--plugin-name", "Alpha Account Unique Attribute",
        "--type", "unique-attribute",
        "--set", "type:fr-idm-account-constraint",
        "--set", "base-dn:ou=account,ou=alpha,dc=openidm," + domain,
        "--set", "enabled:true"

ds.config "create-plugin",
        "--plugin-name", "Bravo Account Unique Attribute",
        "--type", "unique-attribute",
        "--set", "type:fr-idm-account-constraint",
        "--set", "base-dn:ou=account,ou=bravo,dc=openidm," + domain,
        "--set", "enabled:true"

ds.config "create-plugin",
        "--plugin-name", "Pending Account Unique Attribute",
        "--type", "unique-attribute",
        "--set", "type:fr-idm-pending-account-constraint",
        "--set", "base-dn:ou=pendingAccount,dc=openidm," + domain,
        "--set", "enabled:true"

ds.config "create-plugin",
        "--plugin-name", "Alpha Pending Account Unique Attribute",
        "--type", "unique-attribute",
        "--set", "type:fr-idm-pending-account-constraint",
        "--set", "base-dn:ou=pendingAccount,ou=alpha,dc=openidm," + domain,
        "--set", "enabled:true"

ds.config "create-plugin",
        "--plugin-name", "Bravo Pending Account Unique Attribute",
        "--type", "unique-attribute",
        "--set", "type:fr-idm-pending-account-constraint",
        "--set", "base-dn:ou=pendingAccount,ou=bravo,dc=openidm," + domain,
        "--set", "enabled:true"
...
def frIdmReferenceAttributes = []
(1..10).each { i ->
    frIdmReferenceAttributes += ["--set", "attribute-type:fr-idm-reference-${i}"]
}
...
ds.config "create-plugin",
        ...
        "--set", "attribute-type:fr-idm-account-owner",
        "--set", "attribute-type:fr-idm-pending-account-owner",
        ...
        *frIdmReferenceAttributes,
        "--set", "enabled:true"

ds.config "set-backend-prop",
        "--backend-name", backendName,
        "--set", "temporary-base-dn-partition-dn:ou=assoc,ou=recon,dc=openidm," + domain
